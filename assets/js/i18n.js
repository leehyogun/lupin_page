(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "footer.copyright": "© 2026 DreamDo. All rights reserved.",
      ...
      "docs.footer.copyright": "© 2026 DreamDo",
      ...
      "getstarted.step1.desc": "Search for <span class=\"text-yellow-500 font-semibold\">@LupinSpinDevBot</span> in Telegram or tap the link.",
      ...
      "lp.sub": "LP isn't just a game point.<br>It's your share, growing with the DreamDo ecosystem.",
      ...
      "lp.card2.desc": "Use LP across other DreamDo games through Lupin Hub.",
      ...
      "roadmap.sub": "Lupin Spin is just the beginning.<br>DreamDo is building multiple games connected by one economy.",
      ...
      "roadmap.2.desc": "The unified hub mini-app. Heart of the LP economy. Gateway to every DreamDo game.",
      ...
      // ── index: Made by DreamDo ──
      "about.kicker": "Made by DreamDo",
      "about.h2.1": "Grow together.",
      "about.h2.2": "Play together.",
      "about.p1": "DreamDo is a publisher making games on Telegram. We make games where the time you put in turns into real value.",
      ...
      "faq_home.q3": "Can I use LP in other DreamDo games?",
      ...
      "features.f5.item2": "<span class=\"text-slate-300 font-medium\">② Cross-game asset</span> — use in other DreamDo games via Lupin Hub",
      ...
      "features.f5.item4": "<span class=\"text-slate-300 font-medium\">④ Growth-sharing</span> — DreamDo's growth, shared with you",
      "features.f6.title": "Telegram Native",
      "features.f6.desc": "Play directly in Telegram — no separate app install. Open <span class=\"gold\">@LupinSpinDevBot</span> and tap Play to start instantly.",
      ...
      "hp.step1.desc": "In Telegram, search for <a href=\"https://t.me/LupinSpinDevBot\" target=\"_blank\" class=\"text-amber-500 hover:text-amber-400 underline underline-offset-2\">@LupinSpinDevBot</a> or tap the link. Pressing the Play button below the chat opens the Mini App. No separate installation — the game starts right away.",
      ...
      "hp.step6.note": "LP will later be usable in other DreamDo games via Lupin Hub, and exchangeable for tickets and rewards.",
      "hp.tip.title": "🎩 Tip",
      ...
      "faq.a2": "Inside a Telegram Mini App. Open <a href=\"https://t.me/LupinSpinDevBot\" target=\"_blank\" class=\"text-amber-500 hover:text-amber-400 underline underline-offset-2\">@LupinSpinDevBot</a> in Telegram and tap the Play button to start instantly. No separate app install needed.",
      ...
      "faq.q7": "What is LP?",
      "faq.a7": "<span class=\"gold font-semibold\">LP (Lupin Points)</span> is a composite asset, not a simple point: ① in-game currency, ② cross-game asset, ③ exchangeable value, ④ a way to share DreamDo's growth with you. Every play (spin · raid · card) accumulates LP.",
      ...
      "faq.q9": "Can I use LP in other DreamDo games?",
      "faq.a9": "Yes, after Lupin Hub launches. A single LP balance will be usable in DreamDo games launching later — Lupin Casino, Lupin Quest, and more.",
      "faq.q10": "What is DreamDo?",
      "faq.a10": "DreamDo is a publisher of games built as Telegram mini-apps. \"Grow together. Play together.\" — we build experiences where players take part in a game's growth and share in it. Lupin Spin is the first title of our first series (Lupin Series).",
      ...
      "terms.s5.p": "DreamDo is not liable for damages caused by service interruptions, data loss, network errors, or similar. The service is provided as-is.",
    ...
    ko: {
      ...
      "getstarted.step1.desc": "Telegram에서 <span class=\"text-yellow-500 font-semibold\">@LupinSpinDevBot</span>을 검색하거나 링크를 누르세요.",
      ...
      "lp.sub": "LP는 단순한 게임 포인트가 아닙니다.<br>DreamDo 생태계와 함께 자라는, 당신의 몫입니다.",
      "lp.anchor.kicker": "The LP Moment",
      "lp.anchor.caption": "모든 스핀, 모든 카드, 모든 레이드 — 그 끝에 LP가 터진다.",
      "lp.card1.title": "Earn in Play",
      "lp.card1.desc": "슬롯, 레이드, 카드 — 모든 플레이가 LP로 쌓입니다.",
      "lp.card2.title": "Use Anywhere",
      "lp.card2.desc": "Lupin Hub를 통해 DreamDo의 다른 게임에서 사용합니다.",
      "lp.card3.title": "Grow with Us",
      ...
      "roadmap.kicker": "Roadmap",
      "roadmap.h2": "What's Next",
      "roadmap.sub": "Lupin Spin은 시작입니다.<br>DreamDo는 하나의 경제로 연결된 여러 게임을 만들고 있습니다.",
      "roadmap.now.badge": "NOW",
      "roadmap.next.badge": "NEXT",
      "roadmap.then.badge": "THEN",
      "roadmap.later.badge": "LATER",
      ...
      "roadmap.1.desc": "Slot RPG · Beta Live",
      "roadmap.2.title": "Lupin Hub",
      "roadmap.2.desc": "통합 허브 미니앱. LP 경제의 중심. 모든 DreamDo 게임의 관문.",
      "roadmap.3.title": "Lupin Casino",
      ...
      "about.h2.1": "Grow together.",
      "about.h2.2": "Play together.",
      "about.p1": "DreamDo는 Telegram 위에서 게임을 만드는 퍼블리셔입니다. 우리는 플레이어의 시간이 진짜 가치로 남는 게임을 만듭니다.",
      ...
      "faq_home.q3": "다른 DreamDo 게임에서도 LP를 사용할 수 있나요?",
      ...
      "features.f5.item2": "<span class=\"text-slate-300 font-medium\">② 크로스 게임 자산</span> — Lupin Hub로 다른 DreamDo 게임에서 사용",
      "features.f5.item3": "<span class=\"text-slate-300 font-medium\">③ 교환 가능</span> — 특정 시점에 티켓·리워드로 교환",
      "features.f5.item4": "<span class=\"text-slate-300 font-medium\">④ 성장 공유 수단</span> — DreamDo의 성장을 유저와 함께",
      "features.f6.title": "Telegram Native",
      "features.f6.desc": "별도 앱 설치 없이 Telegram 안에서 바로 플레이. <span class=\"gold\">@LupinSpinDevBot</span>을 열고 Play 버튼을 누르면 즉시 시작됩니다.",
      ...
      "hp.step1.desc": "Telegram에서 <a href=\"https://t.me/LupinSpinDevBot\" target=\"_blank\" class=\"text-amber-500 hover:text-amber-400 underline underline-offset-2\">@LupinSpinDevBot</a>을 검색하거나 링크를 누르세요. 채팅창 하단의 Play 버튼을 누르면 Mini App이 실행됩니다. 별도 설치 없이 바로 게임이 시작됩니다.",
      ...
      "hp.step6.note": "LP는 향후 Lupin Hub를 통해 다른 DreamDo 게임에서도 사용하거나, 티켓·리워드로 교환할 수 있게 될 예정입니다.",
      "hp.tip.title": "🎩 Tip",
      ...
      "faq.a2": "Telegram Mini App에서 플레이합니다. <a href=\"https://t.me/LupinSpinDevBot\" target=\"_blank\" class=\"text-amber-500 hover:text-amber-400 underline underline-offset-2\">@LupinSpinDevBot</a>을 Telegram에서 열고 Play 버튼을 누르면 바로 시작됩니다. 별도 앱 설치가 필요하지 않습니다.",
      ...
      "faq.q7": "LP는 무엇인가요?",
      "faq.a7": "<span class=\"gold font-semibold\">LP (Lupin Points)</span>는 단순 포인트가 아닌 복합적 성격의 자산입니다 — ①게임 내 화폐, ②크로스 게임 자산, ③교환 가능한 가치, ④DreamDo의 성장을 유저와 함께 나누는 수단. 모든 플레이(스핀·레이드·카드)가 LP로 쌓입니다.",
      ...
      "faq.q9": "다른 DreamDo 게임에서도 LP를 사용할 수 있나요?",
      "faq.a9": "네, Lupin Hub 출시 이후 가능합니다. 하나의 LP로 Lupin Casino, Lupin Quest 등 향후 출시될 DreamDo 게임에서 사용할 수 있게 됩니다.",
      "faq.q10": "DreamDo는 어떤 회사인가요?",
      "faq.a10": "DreamDo는 Telegram 미니앱 기반 게임 퍼블리셔입니다. \"Grow together. Play together.\" — 플레이어가 게임의 성장에 함께 참여하고, 그 성장을 함께 나누는 경험을 만듭니다. Lupin Spin은 첫 시리즈(Lupin Series)의 첫 작품입니다.",
      ...
      "terms.s5.h2": "5. 면책 조항",
      "terms.s5.p": "DreamDo는 서비스 중단, 데이터 손실, 네트워크 오류 등으로 인한 손해에 대해 책임을 지지 않습니다. 서비스는 현재 상태(as-is)로 제공됩니다.",
      "terms.s6.h2": "6. 약관 변경",
