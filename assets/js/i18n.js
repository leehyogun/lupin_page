(function () {
  ...
  const TRANSLATIONS = {
    ...
    ko: {
      ...
      "gameloop.sub": "Lupin Spin은 그냥 슬롯이 아닙니다.<br>한 번 돌릴 때마다 여정이 한 걸음씩 나아갑니다.",
      "gameloop.step1.title": "SPIN",
      "gameloop.step1.desc": "에너지를 써서 슬롯을 돌립니다.",
      "gameloop.step2.title": "WIN",
      ...
      "gameloop.anchor.p1": "슬롯에서 나오는 특정 심볼을 모아 <span class=\"text-yellow-400 font-semibold\">카드 퀘스트</span>를 완성해 보세요. 완성할 때마다 보너스 골드가 지갑으로 쏟아집니다.",
      "gameloop.anchor.p2": "스핀할 때마다 퀘스트가 한 칸씩 진행되고, 그렇게 모인 골드로 트레저 카드를 키우면 <span class=\"text-yellow-400 font-semibold\">LP</span>로 이어집니다.",
      ...
      "lp.quote": "\"LP is how we stay in this together.\"",
      "lp.quote_sub": "게임이 끝나도 LP는 남습니다.",

      // ── index: Roadmap ──
      "roadmap.kicker": "Roadmap",
      "roadmap.h2": "What's Next",
      "roadmap.sub": "Lupin Spin은 시작일 뿐입니다.<br>DreamDo Games는 하나의 경제로 이어진 여러 게임을 만들고 있습니다.",
      "roadmap.now.badge": "NOW",
      "roadmap.next.badge": "NEXT",
      "roadmap.then.badge": "THEN",
      "roadmap.later.badge": "LATER",
      ...
      "roadmap.1.desc": "Slot RPG · Beta Live",
      "roadmap.2.title": "Lupin Hub",
      "roadmap.2.desc": "여러 게임을 잇는 통합 허브 미니앱. LP 경제의 중심이자 모든 DreamDo Games 게임의 관문입니다.",
      "roadmap.3.title": "Lupin Casino",
      "roadmap.3.desc": "종합 카지노. 슬롯 20여 종과 홀덤, 블랙잭, 보드 게임을 즐길 수 있습니다.",
      "roadmap.4.title": "Lupin Quest",
      "roadmap.4.suffix": "(가제)",
      "roadmap.4.desc": "캐스케이딩 전투 시스템을 갖춘 RPG 슬롯.",

      // ── index: Worlds in Motion ──
      "worlds.kicker": "Worlds in Motion",
      "worlds.h2": "앞으로 추가될 세계들",
      "worlds.sub": "스테이지마다 다른 세계, 다른 보물이 기다립니다.<br>루핀의 컬렉션은 계속 넓어집니다.",
      "worlds.caption": "* 이미지는 개발 중인 콘텐츠로, 실제 출시본과 다를 수 있습니다.",

      // ── index: Made by DreamDo Games ──
      "about.kicker": "Made by DreamDo Games",
      "about.h2.1": "Grow together.",
      "about.h2.2": "Play together.",
      "about.p1": "DreamDo Games는 Telegram에서 게임을 만드는 퍼블리셔입니다. 플레이어가 쏟은 시간이 진짜 가치로 남는 게임을 만들고 있습니다.",
      "about.p2": "Lupin Spin은 그 첫 작품이자 <span class=\"text-yellow-400 font-semibold\">더 큰 생태계의 시작점</span>입니다.",
      "about.principle1.label": "Real Value",
      "about.principle1.desc": "LP는 장식이 아니라 약속입니다. 유저가 얻은 것은 진짜입니다.",
      "about.principle2.label": "One Economy",
      "about.principle2.desc": "하나의 LP로 여러 게임을. 당신이 쌓은 것은 어디서나 살아 있습니다.",
      "about.principle3.label": "Grow Together",
      "about.principle3.desc": "우리가 커지면 당신도 함께 커집니다. 게임이 끝나도 LP가 남는 이유입니다.",

      // ── index: FAQ teaser ──
      "faq_home.kicker": "FAQ",
      "faq_home.h2": "자주 묻는 질문",
      "faq_home.q1": "Lupin Spin은 도박 게임인가요?",
      "faq_home.a1": "아닙니다. Lupin Spin은 슬롯을 코어 루프로 삼는 <strong>Slot RPG</strong>입니다. 실제 현금 베팅은 없고, 게임 속 진행과 성장이 목적입니다.",
      "faq_home.q2": "LP는 언제 티켓이나 리워드로 바꿀 수 있나요?",
      "faq_home.a2": "로드맵 특정 시점에 <strong>Lupin Hub</strong>를 통해 교환할 수 있게 됩니다. 정확한 시점은 추후 공지할 예정입니다.",
      "faq_home.q3": "다른 DreamDo Games 게임에서도 LP를 쓸 수 있나요?",
      "faq_home.a3": "네, Lupin Hub 출시 이후에 가능합니다. 하나의 LP로 여러 게임을 오갈 수 있습니다.",
      "faq_home.see_all": "모든 FAQ 보기",

      // ── features.html ──
      "features.h1": "기능",
      "features.intro": "Lupin Spin은 Telegram에서 돌아가는 <span class=\"gold\">Slot RPG</span>입니다. 슬롯이 중심 엔진 역할을 하고, 그 위에 트레저 카드, 레이드, LP 경제가 얹혀 있습니다.",
      "features.coreloop.h2": "Core Loop",
      "features.coreloop.p": "에너지로 스핀을 돌려 골드와 심볼을 모으고, 트레저 카드를 키워 LP를 얻는 — 이것이 기본 플레이 흐름입니다.",
      "features.coreloop.diagram": "에너지 → <span class=\"gold\">Spin</span> → Win (Gold / Symbol / Card / Quest)<br>&nbsp;&nbsp;&nbsp;&nbsp;→ <span class=\"gold\">Raid</span> (attack · defend · raid)<br>&nbsp;&nbsp;&nbsp;&nbsp;→ Gold → <span class=\"gold\">Treasure Card</span> (구매 · 업그레이드)<br>&nbsp;&nbsp;&nbsp;&nbsp;→ <span class=\"gold\">LP</span> (Lupin Points)<br>&nbsp;&nbsp;&nbsp;&nbsp;→ [Future] Hub에서 다른 게임에 사용 · 리워드로 교환",
      "features.f1.title": "Slot — 모든 것의 시작",
      "features.f1.desc": "에너지로 슬롯을 돌리면 골드, 심볼, 카드, 퀘스트가 나옵니다. 특정 심볼을 모으면 보너스 골드를 얻고, 조합에 따라 레이드나 방어 기회가 열립니다.",
      "features.f2.title": "Treasure Card — 수익형 자산",
      "features.f2.desc": "스테이지마다 그 세계관의 <span class=\"gold\">재화(Wealth)</span>를 상징하는 3종의 보물 아이템이 있습니다. 골드로 사서 업그레이드하면 카드가 활성화되고, 활성 카드는 시간당 토큰을 자동으로 생산합니다.",
      "features.f2.note": "공통 카드 UI에 스테이지별 트레저 아이콘이 들어가는 구조입니다. 방치해 두어도 수익이 쌓입니다.",
      "features.f3.title": "관리인 노아 (NOA)",
      "features.f3.desc": "행운의 신을 대리하는 고양이이자 트레저 카드 관리자입니다. 신비롭지만 만사가 귀찮은 귀차니스트 — 당신의 성장을 귀찮아하면서도 은근히 챙겨 주는 츤데레 조력자입니다.",
      "features.f3.note": "트레저 카드 시스템 가이드이자, 토큰 생산과 수령 흐름을 보여주는 화자 역할을 합니다.",
      "features.f4.title": "Raid &amp; PvP",
      "features.f4.desc": "스핀 결과에 따라 다른 플레이어의 보물을 공격하거나 방어하거나, 레이드에 참여할 수 있습니다. 단순한 슬롯이 아니라 <span class=\"gold\">소셜 PvP 레이어</span>가 살아 있는 이유입니다.",
      "features.f5.title": "LP (Lupin Points) — Cross-Game Asset",
      "features.f5.desc": "모든 플레이가 LP로 쌓입니다. LP는 단순 포인트가 아니라 복합 자산입니다.",
      "features.f5.item1": "<span class=\"text-slate-300 font-medium\">① 게임 내 화폐</span> — Lupin Spin에서 얻고 쓰는 기본 재화",
      "features.f5.item2": "<span class=\"text-slate-300 font-medium\">② 크로스 게임 자산</span> — Lupin Hub를 통해 다른 DreamDo Games 게임에서도 사용",
      "features.f5.item3": "<span class=\"text-slate-300 font-medium\">③ 교환 가능</span> — 특정 시점에 티켓이나 리워드로 교환",
      "features.f5.item4": "<span class=\"text-slate-300 font-medium\">④ 성장 공유 수단</span> — DreamDo Games의 성장이 곧 유저의 성장",
      "features.f6.title": "Telegram Native",
      "features.f6.desc": "별도로 앱을 설치할 필요 없이 Telegram 안에서 바로 플레이할 수 있습니다. <span class=\"gold\">@LupinSpinBot</span>을 열고 Play 버튼을 누르면 바로 시작됩니다.",
      "features.scenario.h2": "세계관 — 위대한 착각, 그리고 진짜 보물",
      "features.scenario.p1": "세상의 온갖 진귀한 물건을 탐내는 천재 도둑 <span class=\"gold\">루핀</span>. 그에게 인생의 유일한 목표는 자신의 은신처를 세상에 하나뿐인 전리품으로 가득 채우는 것입니다.",
      "features.scenario.p2": "어느 날, 보물에서 뿜어져 나오는 부의 기운에 이끌려 정체 모를 고양이 <span class=\"gold\">노아</span>가 찾아옵니다. 만사가 귀찮은 노아는 보물을 관리해 주는 대가로 루핀과 기묘한 동거를 시작합니다.",
      "features.scenario.p3": "노아는 보물의 부의 기운을 정제해 동그란 <span class=\"gold\">토큰</span>으로 만듭니다. 루핀은 그저 \"반짝이는 찌꺼기\"라 여기지만, 사실 이 토큰이야말로 세상 어떤 황금보다 귀한 '부의 정수'입니다.",
      "features.note": "<span class=\"font-semibold\">참고:</span> 기본 플레이는 무료이고, Telegram 계정만 있으면 바로 시작할 수 있습니다. 실제 현금 베팅은 없습니다.",
      "features.prev": "← 이전",
      ...
      // ── how-to-play.html ──
      "hp.h1": "플레이 가이드",
      "hp.intro": "에너지로 슬롯을 돌리고, 카드를 키우고, 다른 플레이어와 경쟁하는 — <span class=\"gold\">Slot RPG</span>의 기본 흐름입니다.",
      "hp.step1.title": "Telegram에서 Lupin Spin 시작하기",
      "hp.step1.desc": "Telegram에서 <a href=\"https://t.me/LupinSpinBot\" target=\"_blank\" class=\"text-amber-500 hover:text-amber-400 underline underline-offset-2\">@LupinSpinBot</a>을 검색하거나 링크를 누르세요. 채팅창 아래 Play 버튼을 누르면 Mini App이 바로 실행됩니다. 따로 설치할 필요 없이 바로 시작할 수 있습니다.",
      "hp.step2.title": "첫 스핀 — 에너지로 슬롯 돌리기",
      "hp.step2.desc": "게임을 시작하면 에너지가 지급됩니다. 에너지 1을 써서 슬롯을 한 번 돌려 보세요. 릴이 멈추면 결과에 따라 골드, 심볼, 카드, 퀘스트 진행도가 한꺼번에 업데이트됩니다.",
      "hp.step3.title": "골드와 심볼 모으기",
      "hp.step3.desc": "슬롯에서 얻은 골드는 자동으로 지갑에 쌓입니다. 특정 심볼을 모으면 <span class=\"gold\">카드 퀘스트</span>가 완료되고, 보너스 골드를 받게 됩니다.",
      "hp.step4.title": "트레저 카드 사고 업그레이드하기",
      "hp.step4.desc": "모은 골드로 스테이지별 <span class=\"gold\">트레저 카드</span>를 사 보세요. 활성화된 카드는 시간당 토큰을 자동으로 생산하고, 업그레이드할수록 생산량이 늘어납니다.",
      "hp.step4.note": "관리인 노아가 보물의 부의 기운을 정제해 토큰으로 바꿔 주는 단계입니다.",
      "hp.step5.title": "다른 플레이어와 대결하기 (Raid · Attack · Defend)",
      "hp.step5.desc": "슬롯 결과에 따라 다른 플레이어를 공격하거나 레이드에 참여할 기회가 생깁니다. 반대로 내 보물이 공격당할 수도 있으니 방어에도 신경 쓰세요.",
      "hp.step6.title": "LP 확인하기",
      "hp.step6.desc": "모든 플레이 활동은 <span class=\"gold\">LP (Lupin Points)</span>로 환산되어 쌓입니다. 게임 내 프로필 화면에서 지금까지 쌓인 LP를 확인할 수 있습니다.",
      "hp.step6.note": "LP는 앞으로 Lupin Hub를 통해 다른 DreamDo Games 게임에서도 쓰거나, 티켓과 리워드로 교환할 수 있게 됩니다.",
      "hp.tip.title": "🎩 Tip",
      "hp.tip.item1": "에너지는 시간이 지나면 자동으로 회복되니 자주 들러서 스핀하세요.",
      ...
      // ── faq.html ──
      "faq.h1": "자주 묻는 질문",
      "faq.intro": "Lupin Spin과 LP 경제에 대해 자주 받는 질문들을 정리했습니다.",
      "faq.group.about": "게임에 대해",
      "faq.group.lp": "LP &amp; 생태계",
      "faq.group.misc": "기타",
      "faq.q1": "Lupin Spin은 도박 게임인가요?",
      "faq.a1": "아닙니다. Lupin Spin은 슬롯을 코어 루프로 삼는 <span class=\"gold font-semibold\">Slot RPG</span>입니다. 실제 현금 베팅은 없고, 게임 속 진행과 성장(트레저 카드 업그레이드, 레이드, LP 축적)이 목적입니다.",
      "faq.q2": "Lupin Spin은 어디서 플레이하나요?",
      "faq.a2": "Telegram Mini App에서 플레이합니다. <a href=\"https://t.me/LupinSpinBot\" target=\"_blank\" class=\"text-amber-500 hover:text-amber-400 underline underline-offset-2\">@LupinSpinBot</a>을 Telegram에서 열고 Play 버튼을 누르면 바로 시작됩니다. 별도로 앱을 설치할 필요는 없습니다.",
      "faq.q3": "무료로 플레이할 수 있나요?",
      "faq.a3": "네, 기본 플레이는 무료입니다. Telegram 계정만 있으면 바로 시작할 수 있습니다.",
      "faq.q4": "에너지는 어떻게 회복되나요?",
      "faq.a4": "시간이 지나면 에너지가 자동으로 차오릅니다. 친구 초대나 시즌 이벤트로 추가 에너지를 받을 수도 있습니다.",
      "faq.q5": "트레저 카드는 어떻게 얻나요?",
      "faq.a5": "스핀으로 얻은 골드로 스테이지별 트레저 카드를 사고 업그레이드할 수 있습니다. 활성화된 카드는 시간당 토큰을 자동으로 생산하고, 같은 스테이지의 3종 카드를 모두 활성화하면 시너지가 발생합니다.",
      "faq.q6": "관리인 노아(NOA)는 누구인가요?",
      "faq.a6": "행운의 신을 대리하는 고양이로, 트레저 카드 관리자 역할을 맡고 있습니다. 만사가 귀찮은 귀차니스트지만 보물의 부의 기운을 정제해 토큰으로 만들어 주는 핵심 조력자입니다.",
      "faq.q7": "LP는 무엇인가요?",
      "faq.a7": "<span class=\"gold font-semibold\">LP (Lupin Points)</span>는 단순한 포인트가 아니라 여러 성격을 가진 자산입니다 — ① 게임 내 화폐, ② 크로스 게임 자산, ③ 교환 가능한 가치, ④ DreamDo Games의 성장을 유저와 함께 나누는 수단. 모든 플레이(스핀·레이드·카드)가 LP로 쌓입니다.",
      "faq.q8": "LP는 언제 티켓이나 리워드로 바꿀 수 있나요?",
      "faq.a8": "로드맵 특정 시점에 <span class=\"gold font-semibold\">Lupin Hub</span>를 통해 교환할 수 있게 됩니다. 정확한 시점은 추후 공지할 예정입니다.",
      "faq.q9": "다른 DreamDo Games 게임에서도 LP를 쓸 수 있나요?",
      "faq.a9": "네, Lupin Hub 출시 이후에 가능합니다. 하나의 LP로 Lupin Casino, Lupin Quest 등 앞으로 출시될 DreamDo Games 게임에서 함께 쓸 수 있게 됩니다.",
      "faq.q10": "DreamDo Games는 어떤 회사인가요?",
      "faq.a10": "DreamDo Games는 Telegram 미니앱 기반 게임을 만드는 퍼블리셔입니다. \"Grow together. Play together.\" — 플레이어가 게임의 성장에 함께 참여하고, 그 성장을 함께 나누는 경험을 만듭니다. Lupin Spin은 첫 시리즈(Lupin Series)의 첫 작품입니다.",
      "faq.q11": "Lupin Hub는 언제 출시되나요?",
      "faq.a11": "Lupin Spin 베타 이후 NEXT 단계로 준비 중입니다. 정확한 시점은 추후 공지하며, 업데이트는 Telegram 채널을 통해 안내할 예정입니다.",
      "faq.q12": "이 사이트는 무슨 용도인가요?",
      "faq.a12": "Lupin Spin의 공식 소개와 문서 사이트입니다. 게임 소개, 플레이 가이드, FAQ, 정책을 안내합니다. 실제 게임은 Telegram Mini App에서 진행됩니다.",
      "faq.q13": "업데이트 공지는 어디서 확인하나요?",
      "faq.a13": "업데이트와 공지사항은 Telegram 채널을 통해 안내합니다. 이 문서 사이트에도 주요 업데이트는 함께 반영됩니다.",
      "faq.prev": "← 이전",
      ...
      "priv.s1.p": "Lupin Spin은 서비스 제공을 위해 Telegram 계정 정보(닉네임, ID)를 수집합니다. 별도의 가입 절차 없이 Telegram 계정과 자동으로 연동됩니다.",
      "priv.s2.h2": "2. 이용 목적",
      "priv.s2.p": "수집한 정보는 게임 서비스 제공, 보상 지급, 고객 지원에만 사용하며, 마케팅 목적으로 쓰지 않습니다.",
      "priv.s3.h2": "3. 보관 기간",
      "priv.s3.p": "서비스 이용 기간 동안 보관하며, 탈퇴 요청 후 30일 이내에 파기합니다. 법령상 보존이 필요한 경우에는 해당 기간 동안 별도로 보관합니다.",
      "priv.s4.h2": "4. 제3자 제공",
      "priv.s4.p": "법령에 따른 경우를 제외하고는 제3자에게 개인정보를 제공하지 않습니다. Telegram 플랫폼의 개인정보처리방침은 별도로 적용됩니다.",
      "priv.s5.h2": "5. 문의",
      "priv.s5.p": "개인정보 관련 문의는 Telegram으로 보내 주세요. 7영업일 이내에 답변드립니다.",
      "priv.prev": "← 이전",
      "priv.prev_title": "FAQ",
      "priv.next": "다음 →",
      ...
      "terms.s1.p": "Lupin Spin은 Telegram Mini App을 통해 제공되는 Slot RPG 게임 서비스입니다. 만 18세 이상만 이용할 수 있으며, 서비스를 이용하면 본 약관에 동의한 것으로 간주합니다.",
      "terms.s2.h2": "2. 가상 재화",
      "terms.s2.p": "게임 내 모든 재화(LP, 골드, 토큰 등)는 가상 재화로 실제 금전적 가치가 없습니다. 환불되지 않으며 계정 간 양도도 불가능합니다.",
      "terms.s3.h2": "3. 계정 정책",
      "terms.s3.p": "계정 공유, 자동화 프로그램(봇) 사용, 부정 행위는 계정 정지 사유가 됩니다. 1인 1계정 원칙을 지켜 주세요.",
      "terms.s4.h2": "4. 이용 제한",
      "terms.s4.p": "서비스 운영 정책을 위반하면 사전 통보 없이 이용이 제한될 수 있습니다. 반복해서 위반할 경우 영구 이용 정지로 이어질 수 있습니다.",
      "terms.s5.h2": "5. 면책 조항",
      "terms.s5.p": "DreamDo Games는 서비스 중단, 데이터 손실, 네트워크 오류 등으로 발생한 손해에 대해 책임지지 않습니다. 서비스는 현재 상태(as-is) 그대로 제공됩니다.",
      "terms.s6.h2": "6. 약관 변경",
      "terms.s6.p": "약관은 사전 공지 후 변경될 수 있습니다. 변경된 뒤에도 서비스를 계속 이용하면 변경된 약관에 동의한 것으로 간주합니다.",
      "terms.prev": "← 이전",
